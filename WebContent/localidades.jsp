			    ...
			    <table class="table">
			    	...
			    	<c:forEach var="localidad" items="${localidades}">
				    	<tr>
				    		...
				    		<td><a href=${"Localidades?action=edit&id="}${localidad.id}><span title="Editar" class="glyphicon glyphicon-pencil"></span></a></td>
				    		<td><a href=${"Localidades?action=delete&id="}${localidad.id} onclick="return confirm('¿Está seguro de que desea dar de baja la localidad?')"><span title="Dar de Baja" class="glyphicon glyphicon-remove"></span></a></td>
				    	</tr>
			    	</c:forEach>
