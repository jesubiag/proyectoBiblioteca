			    ...
			    <table class="table">
			    	...
			    	<c:forEach var="editorial" items="${editoriales}">
				    	<tr>
				    		...
				    		<td><a href=${"Editoriales?action=edit&id="}${editorial.id}><span title="Editar" class="glyphicon glyphicon-pencil"></span></a></td>
				    		<td><a href=${"Editoriales?action=delete&id="}${editorial.id} onclick="return confirm('¿Está seguro de que desea dar de baja la editorial?')"><span title="Dar de Baja" class="glyphicon glyphicon-remove"></span></a></td>
				    	</tr>
			    	</c:forEach>
