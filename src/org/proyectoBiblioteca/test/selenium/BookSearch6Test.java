...
public class BookSearch6Test {
  ...
  @Test
  public void testBookSearch6() throws Exception {
    driver.get(baseUrl + "/proyectoBiblioteca/");
    new Select(driver.findElement(By.name("type"))).selectByVisibleText("Temas");
    driver.findElement(By.name("search")).clear();
    driver.findElement(By.name("search")).sendKeys("magia");
