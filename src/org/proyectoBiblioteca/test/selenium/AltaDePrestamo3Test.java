...
public class AltaDePrestamo3Test {
  ...
  @Test
  public void testAltaDePrestamo3() throws Exception {
    ...
    driver.findElement(By.name("idSocio")).sendKeys("4"); //id de "nicanor", tiene rango 1
    ...
    assertEquals("Préstamo no creado. El socio ingresado no posee el rango suficiente para recibir un ejemplar de este libro.", driver.findElement(By.cssSelector("div.alert.alert-info")).getText());
  }
