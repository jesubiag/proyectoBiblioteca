...
public class BookSearch1Test {
  ...
  @Test
  public void testBookSearch1() throws Exception {
    driver.get(baseUrl + "/proyectoBiblioteca/");
    new Select(driver.findElement(By.name("type"))).selectByVisibleText("Título");
    driver.findElement(By.name("search")).clear();
    driver.findElement(By.name("search")).sendKeys("sarasa");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("No se encontraron resultados. Por favor intente nuevamente.", driver.findElement(By.cssSelector("div.alert.alert-info")).getText());
  }
