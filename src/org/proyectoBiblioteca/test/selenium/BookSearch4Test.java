...
public class BookSearch4Test {
  ...
  @Test
  public void testBookSearch4() throws Exception {
    driver.get(baseUrl + "/proyectoBiblioteca/");
    new Select(driver.findElement(By.name("type"))).selectByVisibleText("ISBN");
    driver.findElement(By.name("search")).clear();
    driver.findElement(By.name("search")).sendKeys("1234546543");
