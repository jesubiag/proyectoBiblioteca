...
public class AltaDePrestamo1Test {
  ...
  public void testAltaDePrestamo1() throws Exception {
    ...
    assertEquals("Préstamo no creado. El socio ingresado no se encuentra habilitado para recibir préstamos.", driver.findElement(By.cssSelector("div.alert.alert-info")).getText());
  }
