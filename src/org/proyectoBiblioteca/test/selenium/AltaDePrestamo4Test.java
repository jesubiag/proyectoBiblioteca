...
public class AltaDePrestamo4Test {
  ...
  public void testAltaDePrestamo4() throws Exception {
	  ...
	  driver.findElement(By.name("idSocio")).sendKeys("2"); //id de mario gimenez, está habilitado
	  ...
	  assertEquals("Préstamo creado con éxito.", driver.findElement(By.cssSelector("div.alert.alert-info")).getText());
  }
