...
public class PrestamoDAOTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		prestamo = new Prestamo(socio,ejemplar,new Date(),false);
	...
	public void testFind() {
		assertEquals(prestamo.getId(),PrestamoDAO.find(id).getId());
	}

	@Test
	public void testUpdate() {
		prestamo.setEstado(EstadoPrestamo.irrecuperable);
		PrestamoDAO.update(prestamo);
		assertEquals(EstadoPrestamo.irrecuperable,PrestamoDAO.find(id).getEstado());
	}
